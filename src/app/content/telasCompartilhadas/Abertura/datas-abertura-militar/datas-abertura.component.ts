...
export class DatasAberturaMilitarComponent implements OnInit,AfterViewInit {
  datasForm: FormGroup;
    ...
    for (const controlName in formControls) {
      if (formControls.hasOwnProperty(controlName) && controlName !== 'anoAtual') {
        ...
        if (control.invalid || control.value === null) {
          ...
          this.contentComponent.changeValidityByComponentName(DatasAberturaMilitarComponent, false);
          return;
        }
      }
    }
    this.contentComponent.changeValidityByComponentName(DatasAberturaMilitarComponent, true);
  }
